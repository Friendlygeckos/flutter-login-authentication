...
import 'package:flutter_login_authentication/views/sign_up_page.dart';
...
class _SignInState extends State<SignIn> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            _authenticateWithGitHub(context);
                          },
                          icon: Image.network(
  ...
  void _authenticateWithGitHub(context) {
    BlocProvider.of<AuthBloc>(context).add(
      GitHubSignInRequested(),
    );
  }

  void _authenticateWithTwitter(context) {
    BlocProvider.of<AuthBloc>(context).add(TwitterSignInRequested());
  }
}
